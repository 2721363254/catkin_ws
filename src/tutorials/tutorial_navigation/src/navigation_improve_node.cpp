...
void printTwistStamped(const geometry_msgs::TwistStamped& twist) {
    ROS_INFO("TwistStamped Message:");
    ROS_INFO("  Header:");
    ROS_INFO("    seq: %u", twist.header.seq);
    ROS_INFO("    stamp: %f sec, %lu nsec", 
             twist.header.stamp.toSec(),
             twist.header.stamp.toNSec());
    ROS_INFO("    frame_id: %s", twist.header.frame_id.c_str());
    ROS_INFO("  Twist:");
    ROS_INFO("    Linear:");
...
int main(int argc, char **argv) {
    ros::init(argc, argv, "navigation_improve_node");
    ros::NodeHandle nh;
